...
**Compile for generate_json_config** : `g++ -std=c++17 -o generate_config_json -I/opt/homebrew/Cellar/boost/1.85.0/include src/generate_config_json.cpp src/symbols.cpp src/configs/*.cpp src/indicators/*.cpp src/neat/*.cpp src/trading/*.cpp src/utils/*.cpp -L/opt/homebrew/lib -lboost_iostreams`
**Run executable for run_training** : `./generate_config_json`