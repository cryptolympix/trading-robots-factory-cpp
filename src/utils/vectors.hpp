 ...
 */
std::vector<double> normalize_vectors(const std::vector<double> &vector, std::pair<double, double> current_range = std::make_pair(0.0f, 0.0f), std::pair<double, double> new_range = std::make_pair(0.0, 1.0));
