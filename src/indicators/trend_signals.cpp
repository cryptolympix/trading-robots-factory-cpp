 ...
 */
ADXSignal::ADXSignal(int period, int threshold, int offset) : Indicator("Average Directional Movement Index Signal", "adx-signal-" + std::to_string(period) + "-" + std::to_string(threshold) + "-" + std::to_string(offset), offset, {0, 1}), period(period), threshold(threshold) {}
 ...
 * @param offset Offset value. Default is 0.
 */
AroonSignal::AroonSignal(int period, int offset) : Indicator("Aroon Signal", "aroon-signal-" + std::to_string(period) + "-" + std::to_string(offset), offset, {-1, 1}), period(period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
CCISignal::CCISignal(int period, int overbought, int oversold, int offset) : Indicator("Commodity Channel Index Signal", "cci-signal-" + std::to_string(period) + "-" + std::to_string(overbought) + "-" + std::to_string(oversold) + "-" + std::to_string(offset), offset, {-1, 1}), period(period), overbought(overbought), oversold(oversold) {}
 ...
 * @param offset Offset value. Default is 0.
 */
DPOSignal::DPOSignal(int period, int offset) : Indicator("Detrended Price Oscillator Signal", "dpo-signal-" + std::to_string(period) + "-" + std::to_string(offset), offset, {-1, 1}), period(period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
EMASignal::EMASignal(std::string source, int period, int offset) : Indicator("Exponential Moving Average Signal", "ema-signal-" + source + "-" + std::to_string(period) + "-" + std::to_string(offset), offset, {-1, 1}), source(source), period(period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
ParabolicSARSignal::ParabolicSARSignal(double acceleration_factor_initial, double acceleration_factor_maximum, int offset) : Indicator("Parabolic Stop and Reverse Signal", "psar-signal-" + std::to_string(acceleration_factor_initial) + "-" + std::to_string(acceleration_factor_maximum) + "-" + std::to_string(offset), offset, {-1, 1}), acceleration_factor_initial(acceleration_factor_initial), acceleration_factor_maximum(acceleration_factor_maximum) {}
 ...
 * @param offset Offset value. Default is 0.
 */
SMASignal::SMASignal(std::string source, int period, int offset) : Indicator("Simple Moving Average Signal", "sma-signal-" + source + "-" + std::to_string(period) + "-" + std::to_string(offset), offset, {-1, 1}), source(source), period(period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
TRIXSignal::TRIXSignal(int period, int offset) : Indicator("Triple Exponential Moving Average Signal", "trix-signal-" + std::to_string(period) + "-" + std::to_string(offset), offset, {-1, 1}), period(period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
VortexSignal::VortexSignal(int period, int offset) : Indicator("Vortex Signal", "vortex-signal-" + std::to_string(period) + "-" + std::to_string(offset), offset, {-1, 1}), period(period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
InstitutionalBiasSignal::InstitutionalBiasSignal(int short_period, int long_period, int offset) : Indicator("Institutional Bias Signal", "ib-signal-" + std::to_string(short_period) + "-" + std::to_string(long_period) + "-" + std::to_string(offset), offset, {-1, 1}), short_period(short_period), long_period(long_period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
IchimokuCloudSignal::IchimokuCloudSignal(int conversion_period, int base_period, int lagging_period, int leading_period, int offset) : Indicator("Ichimoku Cloud Signal", "ichimoku-signal-" + std::to_string(conversion_period) + "-" + std::to_string(base_period) + "-" + std::to_string(lagging_period) + "-" + std::to_string(leading_period) + "-" + std::to_string(offset), offset, {-1, 1}), conversion_period(conversion_period), base_period(base_period), lagging_period(lagging_period), leading_period(leading_period) {}
 ...
 * @param offset Offset value. Default is 0.
 */
IchimokuKijunTenkanSignal::IchimokuKijunTenkanSignal(int conversion_period, int base_period, int lagging_period, int leading_period, int offset) : Indicator("Ichimoku Kijun-Tenkan Signal", "ichimoku-kt-signal-" + std::to_string(conversion_period) + "-" + std::to_string(base_period) + "-" + std::to_string(lagging_period) + "-" + std::to_string(leading_period) + "-" + std::to_string(offset), offset, {-1, 1}), conversion_period(conversion_period), base_period(base_period), lagging_period(lagging_period), leading_period(leading_period) {}
