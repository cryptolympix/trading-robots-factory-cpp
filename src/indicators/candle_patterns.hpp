...
private:
     ...
     */
    bool isClassicDoji(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isLongLeggedDoji(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isDragonflyDoji(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isGravestoneDoji(const std::vector<CandleStick> &candles, size_t index) const;
};
...
private:
     ...
     */
    bool isHammer(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isInvertedHammer(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isShootingStar(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isHangingMan(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isBullishSpinningTop(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isBearishSpinningTop(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isBullishMarubozu(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isBearishMarubozu(const std::vector<CandleStick> &candles, size_t index) const;
};
...
private:
     ...
     */
    bool isBullishEngulfing(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isBearishEngulfing(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isPiercingLine(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isDarkCloudCover(const std::vector<CandleStick> &candles, size_t index) const;
};
...
private:
     ...
     */
    bool isThreeWhiteSoldiers(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isThreeBlackCrows(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isMorningStar(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isEveningStar(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isMorningDojiStar(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isEveningDojiStar(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isThreeInsideUp(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isThreeInsideDown(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isThreeOutsideUp(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isThreeOutsideDown(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isThreeStarsInTheSouth(const std::vector<CandleStick> &candles, size_t index) const;
     ...
     */
    bool isThreeStarsInTheNorth(const std::vector<CandleStick> &candles, size_t index) const;
};
