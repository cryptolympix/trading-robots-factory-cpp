 ...
 */
NewHighSignal::NewHighSignal(int left_bars, int right_bars, int offset) : Indicator("New High Signal", "new-high-signal-" + std::to_string(left_bars) + "-" + std::to_string(right_bars) + "-" + std::to_string(offset), R"(new-high-signal-(\d+)-(\d+)-(\d+))", offset, {0, 1}), left_bars(left_bars), right_bars(right_bars) {}
 ...
 * @param offset Offset value. Default is 0.
 */
NewLowSignal::NewLowSignal(int left_bars, int right_bars, int offset) : Indicator("New Low Signal", "new-low-signal-" + std::to_string(left_bars) + "-" + std::to_string(right_bars) + "-" + std::to_string(offset), R"(new-low-signal-(\d+)-(\d+)-(\d+))", offset, {0, 1}), left_bars(left_bars), right_bars(right_bars) {}
 ...
 * @param offset Offset value. Default is 0.
 */
HighBreakSignal::HighBreakSignal(int left_bars, int right_bars, int offset) : Indicator("High Break Signal", "high-break-signal-" + std::to_string(left_bars) + "-" + std::to_string(right_bars) + "-" + std::to_string(offset), R"(high-break-signal-(\d+)-(\d+)-(\d+))", offset, {0, 1}), left_bars(left_bars), right_bars(right_bars) {}
 ...
 * @param offset Offset value. Default is 0.
 */
LowBreakSignal::LowBreakSignal(int left_bars, int right_bars, int offset) : Indicator("Low Break Signal", "low-break-signal-" + std::to_string(left_bars) + "-" + std::to_string(right_bars) + "-" + std::to_string(offset), R"(low-break-signal-(\d+)-(\d+)-(\d+))", offset, {0, 1}), left_bars(left_bars), right_bars(right_bars) {}
