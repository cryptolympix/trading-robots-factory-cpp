            ...
            .indicators = {
                {
                    TimeFrame::M15,
                    {
                        ...
                        new EMASlope(5, "close"),
                        new EMASlope(9, "close"),
                        new EMASlope(21, "close"),
                        new EMASlope(50, "close"),
                        // new Zigzag(),
                        // Volatility signals
                        // new ATRSignal(),
                        ...
                        // new UI(),
                        new StandardDeviation(5),
                        new StandardDeviation(9),
                        new StandardDeviation(21),
                        new AveragePriceChange(5),
                        new AveragePriceChange(9),
                        new AveragePriceChange(21),
                        // Volume signal
                        // new CMFSignal(),
                        // Volume
                        // new ADL(),
