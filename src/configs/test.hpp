...
Config test_config = {
    ...
    .training{
        ...
        .inputs = {
            .indicators = {
                {TimeFrame::M15, {
                                     new Hour(), new NFPWeek(), new MarketSession("london"), new MarketSession("new-york"), new MarketSession("tokyo"), new WeekDay(), new CandlePriceChange(), new CandleClose(), new PeakDistance(20, 0), new PeakCandleDistance(20, 0), new NewHighSignal(20, 0), new NewLowSignal(20, 0), new HighBreakSignal(20, 0), new LowBreakSignal(20, 0), new MFI(), new RSI(), new StochasticOscillator(), new InstitutionalBias(),
                                     //  new EMADifference(),
                                     //  new AroonTrend(),
                                     //  new IchimokuCloudTrend(),
                                     //  new IchimokuKijunTenkanTrend(),
                                     //  new EMASlope(21, "close"),
                                     new ATR(), new StandardDeviation(), new AveragePriceChange(),
                                     //  new CMF(),
                                     //  new OBV(),
                                     //  new VWAP(),
                                 }}},
